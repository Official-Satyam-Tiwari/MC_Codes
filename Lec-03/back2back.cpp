...
double complex_efficiency(){
    ...
    for(int i=0; i<N_steps; ++i){
        ...
        if(((phi_1_min<phi && phi<phi_1_max) || (phi_2_min<phi && phi<phi_2_max) || (phi_3_min<phi && phi<phi_3_max) || (phi_4_min<phi && phi<phi_4_max) ) && ( (phi_1_min<chi && chi<phi_1_max) || (phi_2_min<chi && chi<phi_2_max) || (phi_3_min<chi && chi<phi_3_max) || (phi_4_min<chi && chi<phi_4_max))){
            double r = SimulateDistance(lambda);
            if(r*cos(phi)<d){
                N_acc++;
            }
